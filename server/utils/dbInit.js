...
async function syncDatabaseSchema() {
  ...
  try {
    console.log("💥 DANGER: EXECUTING ONE-TIME DATABASE RESET & RESTART IDENTITY ON CLOUD...");
    const tables = [
    ...
    console.log("✅ Cloud tables truncated and sequences reset to 1.");
    ...
    for (const u of usersToSeed) {
      ...
      console.log(`👤 Seeded Cloud User: ${u.name} (${u.email})`);
    }
  } catch (resetErr) {
