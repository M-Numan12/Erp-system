...
async function syncDatabaseSchema() {
  ...
  const queries = [
    ...
    `CREATE INDEX IF NOT EXISTS idx_sales_customer_paid ON sales(customer_id, paid_amount);`,
    ...
    `CREATE INDEX IF NOT EXISTS idx_products_module_type ON products(module_type);`,
    `CREATE INDEX IF NOT EXISTS idx_products_name ON products(name);`,
    `CREATE INDEX IF NOT EXISTS idx_salary_payments_staff_id ON salary_payments(staff_id);`,
    `CREATE INDEX IF NOT EXISTS idx_staff_ledger_staff_id ON staff_ledger(staff_id);`,
    ...
    `CREATE INDEX IF NOT EXISTS idx_vehicles_module_type ON vehicles(module_type);`,
    ...
    `UPDATE users SET role = 'Retail 3', module_type = 'Retail 3' WHERE email = 'retail3@erp.com';`,
